...
Measuring a finished agent against this specification is described in
[MERENI.en.md](MERENI.en.md); the blank form is generated by
`python kontrola/brany.py --protokol <version>`.
